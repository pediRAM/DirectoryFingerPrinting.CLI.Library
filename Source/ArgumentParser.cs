            ...
            try
            {
                for (int index = 0; index < args.Length; index++)
                {
                    ...
                    switch (a.ToLower())
                    {
                        ...
                        pOptions.HashAlgo = EHashAlgo.None;
                        break;
                        ...
                        pOptions.HashAlgo = EHashAlgo.CRC32;
                        break;
